...
const ViewProject = () => {
                ...
                <section className=' ' style={{ zIndex: 2 }}>
                        ...
                        <div className='col-md-7 ' style={{ zIndex: -1 }}>
                            ...
                            <div className=' p-desc d-flex justify-content-center'>
                                {isEnrolled ? ( 
                                    ...
                                    <button type='submit' className='btn btn-outline-dark enroll-btn' onClick={enrollFunc}>Click to Enroll</button>
                                )}
                            </div>
                        </div>
                    ...
                    <div className="row d-flex justify-content-center ">
                        <div className="col-md-8">
                            <h3 className='' style={{marginTop:'150px', fontSize:'50px', color:'darkblue', fontFamily:'sans-serif', fontWeight:'bold'}}>Project Description</h3>
                            <p className='text-justify' style={{marginTop:'30px',fontSize:'20px', fontFamily:'serif'}}>{projects.longDesc}</p>
                        </div>
                    </div>
                </section>
    ...
    const displayTask = () => {
        return task.map((t) => (
            <div className='col-md-8 text-justify'>
                <h5 style={{fontSize:'30px'}}>1. {t.head1}</h5>
                <p>{t.desc1}</p>
                <h5 style={{fontSize:'30px'}}>2. {t.head2}</h5>
                <p>{t.desc2}</p>
                <h5 style={{fontSize:'30px'}}>3. {t.head3}</h5>
                <p>{t.desc3}</p>
                <h5 style={{fontSize:'30px'}}>4. {t.head4}</h5>
                <p>{t.desc4}</p>
                <h5 style={{fontSize:'30px'}}>5. {t.head5}</h5>
                <p>{t.desc5}</p>
            {isLoggedIn ? (
    ...
    return (
        <div>
            ...
            <h2 className='task-head d-flex mx-auto py-4'>Task Section : Project Implementation Steps</h2>
